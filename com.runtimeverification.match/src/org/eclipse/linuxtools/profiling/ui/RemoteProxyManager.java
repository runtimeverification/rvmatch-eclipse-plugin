...
import org.eclipse.linuxtools.profiling.launch.LocalFileProxy;
import org.eclipse.linuxtools.profiling.launch.LocalLauncher;
...
public class RemoteProxyManager implements IRemoteProxyManager {
    ...
    protected IRemoteProxyManager getRemoteManager(String schemeId) throws CoreException {
        ...
        if (remoteManager == null) {
            IExtensionPoint extensionPoint = Platform.getExtensionRegistry().getExtensionPoint(RVMatchPlugin.PLUGIN_ID, IRemoteProxyManager.EXTENSION_POINT_ID);
    ...
    public IRemoteFileProxy getFileProxy(URI uri) throws CoreException {
        ...
        if (scheme != null && !scheme.equals(LOCALSCHEME)){
            ...
            if (manager != null)
                ...
                throw new CoreException(new Status(IStatus.ERROR, RVMatchPlugin.PLUGIN_ID,
                        IStatus.OK, "Unrecognized scheme:" + scheme, null));
        }
